...
const CommunicationExpenseForm = ({ formData, onDataChange, onSave, onCancel }) => {
  ...
  return (
    <div className="communication-expense-form">
      <div className="form-header">
        <h3 className="form-title">FORM-04 Communication Expense Form</h3>
      </div>
